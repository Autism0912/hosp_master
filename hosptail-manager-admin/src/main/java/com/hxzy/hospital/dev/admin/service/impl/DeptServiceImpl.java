 ...
 */
@Service
public class DeptServiceImpl extends ServiceImpl<DeptDao, MyDept> implements DeptService  {
    @Autowired
...
//    }
     ...
     */
    @Override
    public List<MyDept> getDeptParent() {
        List<MyDept> myDeptList = deptDao.selectChildrenDeptById(0);

        return myDeptList;
    }

    @Override
    public List<MyDept> getDeptSeed(Integer parentId) {
        List<MyDept> myDeptList = deptDao.selectChildrenDeptById(0);
        return myDeptList;
    }

    @Override
    public List<MyDept> selectDeptAll() {
